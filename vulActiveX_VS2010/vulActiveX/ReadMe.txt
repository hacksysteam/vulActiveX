========================================================================
    ACTIVE TEMPLATE LIBRARY : vulActiveX Project Overview
========================================================================

AppWizard has created this vulActiveX project for you to use as the starting point for
...
vulActiveX.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (vulActiveX.h)
        GUID definitions                                (vulActiveX_i.c)
        A type library                                  (vulActiveX.tlb)
        Marshaling code                                 (vulActiveX_p.c and dlldata.c)

vulActiveX.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in vulActiveX.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named vulActiveX.pch and a precompiled types file named StdAfx.obj.
...
vulActiveXps.vcxproj
	...
	dlldata.c, vulActiveX_i.c and vulActiveX_p.c which are required
	to build the proxy/stub DLL.

vulActiveXps.vcxproj.filters
